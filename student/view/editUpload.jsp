       ...
       //String nicNo = "2016MA0019";
        ...
        if (nicNo!=null &&  (contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {
        	System.out.println("regNo nicccccccc>>>>"+nicNo);    
               ...
               // message = "Successfully Registered! Student Registration No "+nicNo+". SMS has been sent to the student";
...
//your js function
			...
			$("#imageform").attr("action", '/student/control/search/studentClassReg.jsp?action=showSearch');
			$("#imageform").submit();
...
<form id="imageform" method="post" action='/student/control/search/EditStudent.jsp?id=2016EM0'>
