...
function getcategory (){
	$.ajax({
		...
		success	: function(data){
				...
				if(category.length>0){
					...
					for(i=0;i<category.length;i++){
						$var4 = "<tr id='D"+diaId+"'><td width='128'>&nbsp;&nbsp;&nbsp;&nbsp;<span id='FND"+diaId+"'+>"+category[i]+"</span></td><td><a href='#' name='common' id='common' value='Edit' onClick='detectIDandTable("+diaId+","+Dialog+")'><img border='0' src='/my/html/common/images/edit_btn.gif'></td><!--<td><a href='#' name='Dialog' id='common' value='Delete' onClick='deleteVal("+diaId+","+Dialog+")'><img src='/my/html/common/images/delete_btn.gif'></td>--></tr>";
						$("#CATEGORYTB").append($var4);
						diaId++;
					}
				}
		...
		error	:  function(data){
			...
			alert("Error Occured Retriving Existing Data ");		
		},
     ...
     <div id="personalInfo">
      ...
      <tr>
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="title-14px">Manage Class Category</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
              ...
              <tr>
                	<td class="body-bold-text-12px">Class ID :</td>
                 	<td class="body-bold-text-12px">&nbsp;</td>
                  	<td class="body-bold-text-12px">FEE:</td>
                  	<td class="body-bold-text-12px">&nbsp;</td>
