	...
	savePersonalInfo = function() {
		...
		$.ajax({
			...
			success : function(data) {
				...
				//$("#imageform").attr("action", "/student/view/upload.jsp?regisNo=" + data.NIC+ "&nbsp;msg="+data.msg);
    			$("#imageform").attr("action", "/student/view/upload.jsp?regisNo=" +nic+ "&nbsp;msg="+data.msg);
				$("#imageform").submit();
...
<script type="text/javascript">
$('input[name=nic]').on("keyup",function(e){
	  $('[name=imgId]').val($(this).val())
	});
</script>
					...
					<table width="100%" height="100%" border="0" cellspacing="0"
						...
						<tr >
							...
							<td align="left" valign="top"><table width="100%" border="0"
									...
									<tr>
									<td class="title-14px"><div id="response" class="body-bold-text-12px"></div></td>
									</tr>
									<tr>
									<td><br></td>
									</tr>
									<tr>
									<td class="title-14px"><div id="dispalyRegNo"><%=message %></div></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
									</tr>
    ...
    Eg. No: 88 Prince Alfred Tower , Elakiri Lane , Colombo 03.
    ...
    Invalid NIC.
												...
												<tr height="40px">
													...
													<td class="body-bold-text-12px">&nbsp;<b>*</b></td>
													<td><select name="gender" type="text" class="input"
														id="gender">
                 ...
                 -->
												...
												<tr height="40px">
													...
													<td><input name="email" type="text" class="input"
														id="email" onblur="javascript:{this.value = this.value(); }"></td>
													<td class="body-bold-text-12px">&nbsp;</td>
													<td colspan="3" class="body-bold-text-12px"><div id="popup_email">   
    Eg. mHerath@gmail.com
    ...
    Invalid Phone Number .
												...
												<tr height="40px">
													<td class="body-bold-text-12px">Class Location :</td>
													<td class="body-bold-text-12px">&nbsp;<b>*</b></td>
													<td><select name="location" id="location" class="dropdown">
