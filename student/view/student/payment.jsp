...
<script type="text/javascript">
	...
	var regno = null;
	myFunc = function() {
	    var person = prompt("Please Enter Registration Number", "");
	    if (person != null) {
	        regno = person;
	    }
	}
	...
	getClassFee = function (){
		...
		$.ajax({
				type: "POST",
				url: "/student/control/payment/paymentCtrl.jsp",
				data: {action: "getClassFee" , classID: classID},
				time: 10000,
				dataType: "json",
				cache: false,
	...
	savePayment = function (){
		...
		$.ajax({
				type: "POST",
				url: "/student/control/payment/paymentCtrl.jsp",
				data: {action: "savePayment" ,regNo: regNo, classID: classID,classFee: classFee,month: month,paidDate: paidDate,year: year},
				time: 10000,
				dataType: "json",
				cache: false,
				success: function(data){
...
getRelevent = function (){
		...
		$.ajax({
				type: "POST",
				url: "/student/control/payment/paymentCtrl.jsp",
				data: {action: "getRelevent" ,regNo: regNo},
				time: 10000,
				dataType: "json",
				cache: false,
				success: function(data){
     ...
     <div id="personalInfo">
      ...
      <tr>
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="title-14px">Payment Form </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td><div class="body-bold-text-12px" id="response"></div><br>
            <table id="stepOne" border="0" cellpadding="0" cellspacing="0">
             ...
             <tr>
              ...
              <tr>
                ...
                <td class="body-bold-text-12px">&nbsp;</td>
                 <td><input name="classfee" type="text" class="input" id="classfee" readonly></td>
                 <td class="body-bold-text-12px">&nbsp;</td>
              ...
              <tr>
              <tr>
                <td class="body-bold-text-12px">Paying Month/Year :</td>
                <td class="body-bold-text-12px">&nbsp;</td>
                <td>
              ...
              <tr>
                <td class="body-bold-text-12px">Paid Date :</td>
                <td class="body-bold-text-12px">&nbsp;</td>
                 <td><input name="paidDate" type="text" class="input" id="paidDate" readonly></td>
                 <td class="body-bold-text-12px">&nbsp;</td>
                 <td colspan="3" class="body-bold-text-12px">&nbsp;</td>
             </tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
			    <td><div id="response" class="body-bold-text-12px" ></div></td>
			    <td></td>
			    <td>&nbsp;</td>
			    <td>&nbsp;</td>
			  </tr>
