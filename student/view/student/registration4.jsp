	 ...
	 $("#saveInfo").click(function() {
	   ...
	   $('#photoimg').live('change', function()
		   ...
		   var form_url = $("#imageform").attr("action");
		    ...
		    $("#imageform").attr("action","/student/view/upload.jsp?nicVal="+$nicVal);
		    //submit the form
		   $nicVal= $('#nicNo').val();
...
checkNicAvailability = function (){
	...
	var nic = $('#nicNo').val();
		...
		$.ajax({
					type: "POST",
					url: "/student/control/registration/registrationCtrl.jsp",
					data: {action: "saveInfo" , fullName: fullName,initials: initials,lastName: lastName,nic: nic,address: address,district: district,phoneNo: phoneNo,email: email,regNo: regNo,fName: fName,fJob: fJob,fPhone: fPhone,mName: mName,mJob: mJob,mPhone: mPhone,stream: stream},
					time: 10000,
					dataType: "json",
					cache: false,
					success: function(data){
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <table id="stepOne" border="0" cellpadding="0" cellspacing="0">
              <tr><div id="response" class="body-bold-text-12px"></div><br>
             ...
             <tr>
                <td class="body-bold-text-12px">Schoool :</td>
                <td class="body-bold-text-12px">&nbsp;</td>
             ...
             <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td class="body-bold-text-12px">&nbsp;</td>
                 <td><input name="fName" type="text" class="input" id="fName" ></td>
                 <td class="body-bold-text-12px">&nbsp;</td>
                 <td colspan="3" class="body-bold-text-12px">&nbsp;</td>
             </tr>
               <tr>
              ...
              <tr>
                ...
                <td class="body-bold-text-12px">&nbsp;</td>
                 <td><input name="fJob" type="text" class="input" id="fJob" ></td>
                 <td class="body-bold-text-12px">&nbsp;</td>
                 <td colspan="3" class="body-bold-text-12px">&nbsp;</td>
             </tr>
               <tr>
              ...
              <tr>
                ...
                <td class="body-bold-text-12px">&nbsp;</td>
                 <td><input name="fPhone" type="text" class="input" id="fPhone" ></td>
                 <td class="body-bold-text-12px">&nbsp;</td>
                 <td colspan="3" class="body-bold-text-12px">&nbsp;</td>
             </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="body-bold-text-12px">&nbsp;</td>
                 <td><input name="mName" type="text" class="input" id="mName" ></td>
                 <td class="body-bold-text-12px">&nbsp;</td>
                 <td colspan="3" class="body-bold-text-12px">&nbsp;</td>
             </tr>
               <tr>
              ...
              <tr>
                ...
                <td class="body-bold-text-12px">&nbsp;</td>
                 <td><input name="mJob" type="text" class="input" id="mJob" ></td>
                 <td class="body-bold-text-12px">&nbsp;</td>
                 <td colspan="3" class="body-bold-text-12px">&nbsp;</td>
             </tr>
               <tr>
              ...
              <tr>
                ...
                <td class="body-bold-text-12px">&nbsp;</td>
                 <td><input name="mPhone" type="text" class="input" id="mPhone" ></td>
                 <td class="body-bold-text-12px">&nbsp;</td>
                 <td colspan="3" class="body-bold-text-12px">&nbsp;</td>
             </tr> 
              <tr>
