	...
	getAttendance = function (){
		...
		$.ajax({
				...
				success: function(data){
					$("#chart1").show();
					createAttendanceChart(data.students,data.attenDte);
					$("#busyActivate").hide();
...
var plot1;
function createAttendanceChart(numberofStudents,dte){
	if (plot1) {
        plot1.destroy();
    }
	var s1 = null;
     ...
     <div id="personalInfo">
      ...
      <tr>
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="title-14px">View Student Attendance </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
            ...
            <tr>
                <td class="body-bold-text-12px">Class Category :</td>
                 ...
                 <%
                  ...
                  <td class="body-bold-text-12px">&nbsp;</td>
                 <td colspan="3" class="body-bold-text-12px"><div id="dispalyRegNo" ></div><div id="tmpReg" ></div></td>
              </tr>
              <tr>
                <td colspan="7" height="10px" class="body-bold-text-12px">(X Axis--> Attended Date)</td>
                
              </tr>
              <tr>
                <td colspan="7" height="10px" class="body-bold-text-12px">(Y Axis --> Number of Students)</td>
              </tr>
             <tr>
                <td colspan="7" height="10px"></td>
             </tr>
              <tr>
                <td  height="10px"><div id="chart1" class="plot" style="width:500px;height:380px;"></div></td>
