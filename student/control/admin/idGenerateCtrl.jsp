...
<script type="text/javascript">
   function studentSearch(){
	   if($("#stuId").val()=='' || $("#stuId").val().length <=0){
		   alert("Please enter the registration ID");
		   return;
	  }
	    $.post("manageIDCard.jsp",{ regNo: $("#stuId").val()}, function(data) {
	    	$('#showReslt').show();
			$("#showReslt").html(data);
	   }); 
     ...
     <div id="personalInfo">
      ...
      <tr>
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="title-14px">Generate Student ID</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <table id="stepOne" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="body-bold-text-12px">Enter Student ID :</td>
                 <td class="body-bold-text-12px">&nbsp;</td>
                  <td class="body-bold-text-12px" >
					<input name="stuId" type="text" class="input" id="stuId"/>    			          			 
                  </td>
                  <td class="body-bold-text-12px">&nbsp;</td>
